...
$$\bar{v}_i = \frac{\partial f}{\partial v_i} = \sum_{j} \frac{\partial f}{\partial v_j} \cdot \frac{\partial v_j}{\partial v_i} = \sum_{j} \bar{v}_{j} \cdot \frac{\partial v_j}{\partial v_i}.$$
