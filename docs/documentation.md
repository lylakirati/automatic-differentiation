...
$$\bar{v}_{i} = \frac{\partial f}{\partial v_{i}} = \sum_{j} \frac{\partial f}{\partial v_{j}} \cdot \frac{\partial v_{j}}{\partial v_{i}} = \sum_{j} \bar{v}_{j} \cdot \frac{\partial v_{j}}{\partial v_{i}}.$$
