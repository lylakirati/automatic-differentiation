...
$$\bar{v}_i = \frac{\partial f}{\partial v_i} = \sum_{j,\;a\;child\;of\;i} \frac{\partial f}{\partial v_j} \cdot \frac{\partial v_j}{\partial v_i} = \sum_{j,\;a\;child\;of\;i} \bar{v}_j \cdot \frac{\partial v_j}{\partial v_i}.$$ 
